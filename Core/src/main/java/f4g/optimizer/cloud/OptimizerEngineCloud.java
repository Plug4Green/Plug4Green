...
import f4g.optimizer.btrplace.plan.action.F4GDriver;
import f4g.optimizer.btrplace.plan.action.F4GDriverFactory;
import f4g.optimizer.btrplace.plan.constraint.CMaxServerPower;
import f4g.optimizer.btrplace.plan.constraint.CNoStateChange;
import f4g.optimizer.btrplace.plan.constraint.CSpareNodes;
import f4g.optimizer.btrplace.plan.constraint.factories.ClusterConstraintFactory;
import f4g.optimizer.btrplace.plan.constraint.factories.ModelConstraintFactory;
import f4g.optimizer.btrplace.plan.constraint.factories.PolicyConstraintFactory;
import f4g.optimizer.btrplace.plan.constraint.factories.SLAConstraintFactory;
import f4g.optimizer.btrplace.plan.objective.CPowerObjective;
import f4g.optimizer.btrplace.plan.objective.api.PowerObjective;
