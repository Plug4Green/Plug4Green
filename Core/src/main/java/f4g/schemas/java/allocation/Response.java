...
/**
 * Allocation response for different computing styles
 * 
...
@XmlSeeAlso({
    CloudVmAllocationResponse.class
})
public abstract class Response implements Cloneable, Named, Visitable, CopyTo
{
     ...
     * 
     */
    public Response(final QName jaxbElementName) {
