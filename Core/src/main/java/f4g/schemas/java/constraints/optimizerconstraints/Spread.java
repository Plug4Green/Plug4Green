...
/**
 * <p>Java class for Spread complex type.
 * 
    ...
    implements Cloneable, Visitable, CopyTo
{
     ...
     * 
     */
    public Spread(final List<String> vmName) {
        super();
        this.vmName = vmName;
    }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Spread) {
            final Spread copy = ((Spread) draftCopy);
