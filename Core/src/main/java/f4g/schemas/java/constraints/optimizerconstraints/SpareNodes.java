...
/**
 * <p>Java class for spareNodes complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="spareNodes"&gt;
 *   &lt;simpleContent&gt;
...
@XmlType(name = "spareNodes", propOrder = {
    "value"
})
public class SpareNodes implements Cloneable, Visitable, CopyTo
{
     ...
     * 
     */
    public SpareNodes(final int value, final UnitType unitType) {
        this.value = value;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof SpareNodes) {
            final SpareNodes copy = ((SpareNodes) draftCopy);
            int sourceValue;
