...
public class VMGroup implements Cloneable, Visitable, CopyTo
{
     ...
     * 
     */
    public VMGroup(final List<String> vmName) {
        this.vmName = vmName;
    }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof VMGroup) {
            final VMGroup copy = ((VMGroup) draftCopy);
