...
/**
 * <p>Java class for Dimension simple type.
 * 
...
public class Dimension implements Cloneable, Visitable, CopyTo
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof Dimension) {
            final Dimension copy = ((Dimension) draftCopy);
            int sourceValue;
