...
/**
 * <p>Java class for TowerServer complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TowerServer"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "TowerServer", propOrder = {
    "psu",
    "fan",
    "waterCooler"
})
    ...
    implements Cloneable, Visitable, CopyTo
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof TowerServer) {
            final TowerServer copy = ((TowerServer) draftCopy);
