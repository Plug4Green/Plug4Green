...
/**
 * <p>Java class for RAIDDisk complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RAIDDisk"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "RAIDDisk", propOrder = {
    "raidDiskId",
    "level",
    "computedPower",
    "readRate",
...
public class RAIDDisk implements Cloneable, Named, Visitable, CopyTo
{
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof RAIDDisk) {
            final RAIDDisk copy = ((RAIDDisk) draftCopy);
            if (this.raidDiskId!= null) {
                String sourceRaidDiskId;
                sourceRaidDiskId = this.getRaidDiskId();
                String copyRaidDiskId = ((String) strategy.copy(LocatorUtils.property(locator, "raidDiskId", sourceRaidDiskId), sourceRaidDiskId));
                copy.setRaidDiskId(copyRaidDiskId);
            } else {
                copy.raidDiskId = null;
            }
            if (this.level!= null) {
