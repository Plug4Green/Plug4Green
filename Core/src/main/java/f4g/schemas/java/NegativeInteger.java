...
public class NegativeInteger implements Cloneable, Visitable, CopyTo
{
     ...
     * 
     */
    public NegativeInteger(final NonPositiveInteger value) {
        this.value = value;
    }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof NegativeInteger) {
            final NegativeInteger copy = ((NegativeInteger) draftCopy);
            if (this.value!= null) {
                NonPositiveInteger sourceValue;
                sourceValue = this.getValue();
                NonPositiveInteger copyValue = ((NonPositiveInteger) strategy.copy(LocatorUtils.property(locator, "value", sourceValue), sourceValue));
