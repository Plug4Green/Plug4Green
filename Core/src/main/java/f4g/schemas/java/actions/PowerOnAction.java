...
/**
 * <p>Java class for PowerOnAction complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PowerOnAction"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "PowerOnAction", propOrder = {
    "nodeName"
})
public class PowerOnAction
    ...
    implements Cloneable, Visitable, CopyTo
{
     ...
     * 
     */
    public PowerOnAction(final String id, final String frameworkName, final Boolean forwarded, final XMLGregorianCalendar forwardedAt, final QName jaxbElementName, final String nodeName) {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof PowerOnAction) {
            final PowerOnAction copy = ((PowerOnAction) draftCopy);
