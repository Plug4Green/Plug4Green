 ...
 * 
 * <p>Java class for LiveMigrateVMAction complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LiveMigrateVMAction"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "LiveMigrateVMAction", propOrder = {
    "virtualMachine",
    "sourceNodeController",
    "destNodeController"
})
public class LiveMigrateVMAction
    ...
    implements Cloneable, Visitable, CopyTo
{
     ...
     * 
     */
    public LiveMigrateVMAction(final String id, final String frameworkName, final Boolean forwarded, final XMLGregorianCalendar forwardedAt, final QName jaxbElementName, final String virtualMachine, final String sourceNodeController, final String destNodeController) {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy strategy) {
        ...
        if (draftCopy instanceof LiveMigrateVMAction) {
            final LiveMigrateVMAction copy = ((LiveMigrateVMAction) draftCopy);
